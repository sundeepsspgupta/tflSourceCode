...
6. Second projct is TFL.Config. This project contains the configurations details in appsetting.json i.e. Keys like primary, secondry, base url api, and api endpoint.
...
9. A Unit test project is also added. This is xUnit project type which contains three test cases and config file appsetting.json file. 
